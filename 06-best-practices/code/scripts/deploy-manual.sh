...
export MODEL_BUCKET_PROD="stg-mlflow-models-code-owners-r-mlops-zoomcamp"
export PREDICTIONS_STREAM_NAME="stg_ride_predictions_r-mlops-zoomcamp"
export LAMBDA_FUNCTION="stg_prediction_lambda_r_mlops-zoomcamp"

# Model artifacts bucket from the previous weeks (MLflow experiments)
export MODEL_BUCKET_DEV="ml-flow-artifacts-remote445"
